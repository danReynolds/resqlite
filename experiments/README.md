...
| [141](141-resultset-foreach.md) | ResultSet `forEach` fast path | Direct `ResultSet.forEach` traversal improves lookup-heavy row consumption by 15-20% in focused AOT pairs while indexed controls stay within the local noise band |  |
