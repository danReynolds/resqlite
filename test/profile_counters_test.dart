...
void main() {
  ...
  test('snapshot, diff, and reset include stream counters', () {
    ...
    ProfileCounters.streamRerunsSkippedBeforeDispatch = 4;
    ProfileCounters.streamRerunPoolWaitUs = 11;
    ProfileCounters.streamRerunRoundTripUs = 13;
    ProfileCounters.streamRerunWorkerExecUs = 17;
    ProfileCounters.streamRerunCompletionUs = 19;
    ...
    ProfileCounters.streamRerunsSkippedBeforeDispatch += 6;
    ProfileCounters.streamRerunPoolWaitUs += 23;
    ProfileCounters.streamRerunRoundTripUs += 29;
    ProfileCounters.streamRerunWorkerExecUs += 31;
    ProfileCounters.streamRerunCompletionUs += 37;
    ...
    expect(ProfileCounters.diff(before, ProfileCounters.snapshot()), {
      ...
      'stream_reruns_skipped_before_dispatch': 6,
      'stream_rerun_pool_wait_us': 23,
      'stream_rerun_round_trip_us': 29,
      'stream_rerun_worker_exec_us': 31,
      'stream_rerun_completion_us': 37,
    ...
    expect(ProfileCounters.snapshot(), {
      ...
      'stream_reruns_skipped_before_dispatch': 0,
      'stream_rerun_pool_wait_us': 0,
      'stream_rerun_round_trip_us': 0,
      'stream_rerun_worker_exec_us': 0,
      'stream_rerun_completion_us': 0,
