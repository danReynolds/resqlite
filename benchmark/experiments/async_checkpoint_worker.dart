...
//
// Focused A/B harness for exp 233's asynchronous checkpoint worker.
//
...
// payload inserts so it crosses the threshold repeatedly while periodically
// sampling foreground reads. SQLITE_CHECKPOINT_NOOP observes WAL progress
// without performing checkpoint work itself.
...
String _renderMarkdown({
  ...
  final output = StringBuffer()
    ..writeln('# Async checkpoint worker benchmark (exp 233)')
    ..writeln()
    ..writeln(
...
const _usage =
    '''
Focused exp 233 asynchronous checkpoint-worker benchmark.

Usage:
  dart run benchmark/experiments/async_checkpoint_worker.dart [options]
