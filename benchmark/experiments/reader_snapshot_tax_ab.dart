...
///
///   * the archived warm-rerun candidate (a stream rerun on the idle writer
///     connection) — build separate AOT bundles from `archive/exp-289^`
///     (baseline) and `archive/exp-289` (candidate), alternate arm order, and
///     compare lanes; publication main contains no runtime toggle;
...
/// caller awaits an emission rather than a write, so the archived prototype's
/// point-in-time idle signals say the writer is free while the next iteration's
/// write is about to arrive.
