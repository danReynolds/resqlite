...
/// runs every stream rerun on a reader connection, and every rerun is by
/// construction preceded by a commit on the writer connection, so every rerun
/// begins with a cold page cache. The writer's own cache is never reset by its
/// own commits.
///
...
///
///   reader/warm         no write between passes (never happens in production)
