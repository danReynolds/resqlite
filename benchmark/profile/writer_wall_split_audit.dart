...
//
// Writer wall split audit - exp 127.
//
// This profile harness consumes the writer timing counters added for exp 127:
...
String _renderMarkdown(List<_WriterWallRow> rows, int repeats) {
  ...
  buf.writeln('# Experiment 127 - Writer Wall Split Audit');
  buf.writeln();
  buf.writeln(
  ...
  for (final row in rows) {
    buf.writeln(
      ...
      '${row.roundtripUs} | ${row.writeCallUs} | ${row.dirtyFetchUs} | '
