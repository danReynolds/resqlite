...
git -C /path/to/tracelite checkout resqlite-profiling-gate-2026-06-02-r3
```
...
The default pin is
`fb1a7ee05249a6e5a5695e6b8a6169531ec28bc9`
(`resqlite-profiling-gate-2026-06-02-r3`). The wrapper records
